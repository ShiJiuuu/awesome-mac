...
* [RunCat](https://github.com/Kyome22/RunCat_for_windows) - A status display app for your computer, hidden in the menu bar, with CPU, RAM, Disk, Battery, Network status display, the menu bar will turn into a running kitten or other dynamic icon you like. [![Open-Source Software][OSS Icon]](https://github.com/Kyome22/RunCat_for_windows) ![Freeware][Freeware Icon] [![App Store][app-store Icon]](https://apps.apple.com/cn/app/runcat/id1429033973?mt=12)
